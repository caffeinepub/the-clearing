    ...
    <SectionShell accentLabel="Ethics & Boundaries" motifVariant="grain" backgroundVariant="subtle">
      ...
      <div className="space-y-10 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
        <p className="text-foreground/90">
          This work is <span className="text-gold font-medium">not therapy</span>, <span className="text-gold font-medium">not medical advice</span>, 
          and <span className="text-gold font-medium">not a substitute for professional mental health care</span>.
        </p>
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 pl-8">
            <li className="flex items-start">
              <span className="mr-4 text-gold/60 text-xl">—</span>
        ...
        <p className="text-center text-xl text-foreground font-light italic tracking-wide border-t border-gold/20 pt-12">
